...
let __dirname$2;
try {
  __dirname$2 = url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs.js', document.baseURI).href)));
} catch (e) {
  __dirname$2 = process.cwd();
}
...
({
  ...
  y18n: y18n({
    directory: path.resolve(__dirname$2, '../../../locales'),
    updateFiles: false
  })
});
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 103:
          ...
          break;
        case 105:
          console.warn("Trigger ".concat(triggerName, " has no action statement."));
        case 106:
          _context2.next = 85;
          break;
        case 108:
...
var findDifferences = function findDifferences(expected, current) {
  ...
  for (var _i2 = 0, _Object$entries = Object.entries(expected.tables); _i2 < _Object$entries.length; _i2++) {
    ...
    // Detect extra fields
    var _iterator = _createForOfIteratorHelper(current.tables[_tableName].columns),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    try {
      var _loop = function _loop() {
        ...
        if (!currentField) {
          console.error('Current field not found for', field.Field, 'in table', _tableName);
          differences.push({
            type: 'missing_field',
            tableName: _tableName,
            field: field
    ...
    var _iterator4 = _createForOfIteratorHelper(current.tables[_tableName].indexes),
      _step4;
    try {
    ...
    var _iterator6 = _createForOfIteratorHelper(current.tables[_tableName].triggers),
      _step6;
    try {
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  logger("Executing: ".concat(createDatabaseSQL));
                  _context.next = 7;
                ...
                case 10:
                  ...
                  logger("Executing: ".concat(createSQL));
                  _context.next = 16;
                ...
                case 18:
                  ...
                  logger("Executing: ".concat(dropTableSQL));
                  _context.next = 25;
                ...
                case 45:
                  ...
                  logger("Executing: ".concat(dropFieldSQL));
                  _context.next = 50;
                ...
                case 52:
                  ...
                  _defaultClause = field.Default === 'CURRENT_TIMESTAMP' ? 'DEFAULT CURRENT_TIMESTAMP' : field.Default !== undefined && field.Default !== null ? "DEFAULT '".concat(field.Default, "'") : '';
                  _dropFieldSQL = "ALTER TABLE `".concat(_tableName2, "` CHANGE `").concat(field.Field, "` `").concat(field.Field, "` ").concat(field.Type, " ").concat(field.NotNull ? 'NOT NULL' : '', " ").concat(_defaultClause, ";");
                ...
                case 70:
                  ...
                  logger("Executing: ".concat(primaryKeySQL));
                  _context.next = 77;
                ...
                case 82:
                  ...
                  logger("Executing: ".concat(addIndexSQL));
                  _context.next = 88;
                ...
                case 93:
                  ...
                  logger("Executing: ".concat(dropPrimaryKeySQL));
                  _context.next = 99;
                ...
                case 101:
                  ...
                  logger("Executing: ".concat(dropIndexSQL));
                  _context.next = 105;
                ...
                case 107:
                  ...
                  logger("Executing: ".concat(_dropPrimaryKeySQL));
                  _context.next = 114;
                ...
                case 116:
                  ...
                  logger("Executing: ".concat(_dropIndexSQL));
                  _context.next = 120;
                ...
                case 120:
                  ...
                  logger("Executing: ".concat(addPrimaryKeySQL));
                  _context.next = 127;
                ...
                case 129:
                  ...
                  logger("Executing: ".concat(_addIndexSQL));
                  _context.next = 133;
                ...
                case 135:
                  ...
                  logger("Executing: ".concat(dropCurrentProcSQL));
                  _context.next = 140;
                  return connection.query(dropCurrentProcSQL);
                case 140:
                  // Create the procedure
                  createProcSQL = diff.Definition;
                  logger("Executing: ".concat(createProcSQL)); // Log the SQL statement
                  _context.next = 144;
                ...
                case 168:
                  ...
                  logger("Executing: ".concat(_dropViewSQL2));
                  _context.next = 173;
                ...
                case 183:
                  ...
                  logger("Executing: ".concat(dropTriggerSQL));
                  _context.next = 188;
                ...
                case 194:
                  ...
                  logger("Executing: ".concat(_dropTriggerSQL));
                  _context.next = 199;
                ...
                case 201:
                  ...
                  logger("Executing: ".concat(_createDatabaseSQL));
                  _context.next = 207;
...
var compareAllDatabases = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(connection, inputDir) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 40:
          ...
          database = _step2.value;
          console.log("Creating database ".concat(database, "..."));
          _context.next = 45;
          return connection.query("CREATE DATABASE `".concat(database, "`;"));
        case 45:
          console.log("Database ".concat(database, " created."));
        case 46:
          _context.next = 40;
          break;
        case 48:
        ...
        case 66:
          ...
          console.log('Skipping database', _database2, 'because it is missing');
          return _context.abrupt("continue", 98);
        case 69:
        ...
        case 73:
          ...
          console.log('Getting database structure for', _database2);
          _context.next = 78;
          return getDatabaseStructure(connection, _database2, command, options);
        case 78:
          currentStructure = _context.sent;
          console.log('Database structure for', _database2, 'obtained');
          differences = findDifferences(expectedStructure, currentStructure);
          console.log('Differences for', _database2, 'obtained');
          if (update) {
            _context.next = 87;
            break;
          }
          console.log('Logging differences for', _database2);
        ...
        case 87:
          ...
          console.log('Applying differences for', _database2);
          _context.next = 92;
        ...
        case 95:
          ...
          console.error("Error processing database ".concat(_database2, ":"), _context.t2.message);
        case 98:
          _context.next = 62;
          break;
        case 100:
    ...
    }, _callee, null, [[18, 29, 32, 35], [38, 50, 53, 56], [60, 102, 105, 108], [70, 95]]);
  }));
...
var startApiServer = function startApiServer(port, argv) {
  ...
  var __dirname = process.platform === "win32" ? process.cwd().replace(/\\/g, '/') : process.cwd();
    ...
    var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            _context8.prev = 0;
            _req$body$currentPath = req.body.currentPath, currentPath = _req$body$currentPath === undefined ? process.cwd() : _req$body$currentPath;
            console.log('Browsing folder:', currentPath);
            resolvedPath = currentPath.startsWith('/') || currentPath.match(/^[A-Z]:\\/) ? path.resolve(currentPath) : path.resolve(process.cwd(), currentPath);
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ...
            resolvedPath = folderPath.startsWith('/') || folderPath.match(/^[A-Z]:\\/) ? path.resolve(folderPath) : path.resolve(process.cwd(), folderPath);
            _context9.next = 6;
...
const __dirname$1 = path$1.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('index.cjs.js', document.baseURI).href))));
...
var compare = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(config, output) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          return _context4.abrupt("return", new Promise(function (resolve, reject) {
            try {
              var checker = new DBStructureChecker(config);
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 12:
          ...
          checker.connection.on('connect', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
